...
window.PORTFOLIO_CLASS_META = {
  cash:  { label: '現金 / 存款', color: TOKENS.sage },
  stock: { label: '股票',        color: TOKENS.accent },
  bond:  { label: '債券',        color: TOKENS.gold },
  other: { label: '其他資產',    color: TOKENS.sageDark },
};

// Used by dashboard widget + advisor health check
window.PORTFOLIO_GROUPS = [
  { id: 'stocks', name: '股票持倉',       color: TOKENS.accent, icon: 'TrendUp',   sign: 1, assetClass: 'stock', detail: 'holding', items: [] },
  { id: 'bonds',  name: '債券',           color: TOKENS.gold, icon: 'Activity',  sign: 1, assetClass: 'bond',  detail: 'holding', items: [] },
  { id: 'cash',   name: '現金',           color: TOKENS.sage, icon: 'Wallet',    sign: 1, assetClass: 'cash',  items: [] },
  { id: 'bank',   name: '銀行',           color: TOKENS.gold2, icon: 'Banknote',  sign: 1, assetClass: 'cash',  items: [] },
  { id: 'epay',   name: '儲值/電子支付', color: TOKENS.gold3, icon: 'Smartphone',sign: 1, assetClass: 'cash',  items: [] },
  { id: 'other',  name: '其他',           color: TOKENS.sageDark, icon: 'Key',       sign: 1, assetClass: 'other', items: [] },
  { id: 'credit', name: '信用卡 (負債)',  color: TOKENS.accent2, icon: 'CreditCard',sign:-1, assetClass: 'debt',  items: [] },
];

// ─── 資產頁帳戶分類（依帳戶種類）─────────────────────────────────────────
window.ASSET_GROUPS = [
  {
    id: 'credit', name: '信用卡', icon: 'CreditCard', color: TOKENS.accent2,
    sign: -1, assetClass: 'debt',
    items: [],
  },
  {
    id: 'cash', name: '現金', icon: 'Banknote', color: TOKENS.sage,
    sign: 1, assetClass: 'cash',
    items: [],
  },
  {
    id: 'bank', name: '銀行', icon: 'Wallet', color: TOKENS.gold2,
    sign: 1, assetClass: 'cash',
    items: [],
  },
  {
    id: 'brokerage', name: '交割戶', icon: 'TrendUp', color: TOKENS.accent,
    sign: 1, assetClass: 'stock',
    items: [],
  },
  {
    id: 'prepaid', name: '儲值卡', icon: 'Tag', color: TOKENS.sageDark,
    sign: 1, assetClass: 'cash',
    items: [],
  },
  {
    id: 'epay', name: '電子支付', icon: 'Smartphone', color: TOKENS.gold3,
    sign: 1, assetClass: 'cash',
    items: [],
  },
  {
    id: 'other', name: '其他', icon: 'Key', color: TOKENS.gold,
...
window.INVEST_HOLDINGS = [
  { id: 'stock',      name: '股票',    color: TOKENS.accent, items: [] },
  { id: 'bond-etf',   name: '債券ETF', color: TOKENS.gold, items: [] },
  { id: 'market-etf', name: '大盤ETF', color: TOKENS.sage, items: [] },
  { id: 'active-etf', name: '主動ETF', color: TOKENS.gold2, items: [] },
  { id: 'theme-etf',  name: '主題ETF', color: TOKENS.gold3, items: [] },
];
